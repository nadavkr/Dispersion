...
\title{Dispersion on Trees\thanks{A preliminary version of this paper appeared in ESA 2017.} \thanks{The research was supported in part by Israel Science Foundation grants 794/13 and 592/17.}}
\author[1]{Pawe\l{} Gawrychowski}
\author[2]{Nadav Krasnopolsky}
\author[3]{Shay Mozes}
\author[2]{Oren Weimann}
\affil[1]{University of Wroc\l{}aw, Poland}
\affil[2]{University of Haifa, Israel}
\affil[3]{IDC Herzliya, Israel}
...
such valid subsets with maximal cardinality, $\min_{u\in P} d(r,u)$ is maximal. 
