...
<<<<<<< HEAD
(\cite{Bhattacharya1991}) and takes $O(n\log n)$ time, after Wang and Kuo solved the problem in the one dimensional case with a running time of $O(np + nlogn)$ \cite{Wang1988}. Using the
=======
