...
considered, and $\Oh(n\log^2n)$ time algorithm is known %cite Cole and
...
\cite{Bhattacharya1991} and takes $\Oh(n\log n)$ time, improving on an earlier $\Oh(n^2)$
solution \cite{Wang1988}. Using the
