...
the necessary properties: the leaves' distances from the root and hole need to be monotone, and there should be
no collisions between candidate nodes and certain nodes in the caterpillar. Once we have these properties, we will
