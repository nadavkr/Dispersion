...
i.e., on a path. However, such equivalence seems problematic for general trees. %TODO explain equivalence
...
the some of our techniques might be somehow simpler than his. %TODO explain more
...
decompositions.%TODO explain more?

The bottleneck in the obtained $O(n\log^{*}n$) time algorithm is the preprocessing time necessary
