...
%TODO high level description  - technical overview of methods
%natural way - binary search over the possible \lambda
%but can't realy b.s. so we use frederickson
...
\noindent The decision problem is also called the {\em feasibility test}.
...
\begin{figure}
\begin{center}
\includegraphics[scale=1]{fragment}
\end{center}
\caption{Example of a fragment in a good partition.}
\end{figure}
...
\end{center}
\caption{A single step in the recursive procedure for constructing a sorted list of distances from $v$.}
\end{figure}
...
\end{center}
\caption{Pruning the caterpillar by removing $u_{i}$.}
\end{figure}
