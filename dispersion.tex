...
Having reduced a large fragment to a large caterpillar, we are now left only with preprocessing these large caterpillar for every possible eliminated suffix.
