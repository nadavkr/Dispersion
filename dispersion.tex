...
\end{center}
\caption{Example of a fragment in a good partition. The fragment consists of the subtree of $u$ without the subtree of $v$. We call $u$ the \emph{root} of the fragment and $v$ the \emph{hole} of the fragment.}
\end{figure}
...
\end{proof}
We now describe a single iteration, i.e. how to construct an $O(\frac{n}{B^4} \times \log B)$ time test given an $O(\frac{n}{b^4} \times \log b)$ test.
