...
\title{Dispersion on Trees\protect \thanks{The research was supported in part by Israel Science Foundation grant 794/13.} \footnote{The full version of this paper, containing missing proofs and supplementary figures, can be found at %TODO add link%
}}
...
Thus the details of the linear-time algorithm are technically involved and appear in Section 4 of the full version.
...
The full description of Operation 6-8 is in the full version.
