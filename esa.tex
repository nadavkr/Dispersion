...
\section{Proof of Lemma~\ref{lemma of the reduction to set disjointness}}\label{appendix proof of reduction lemma}
...
\section{Proof of Lemma~\ref{nlog^2n running time for weighted f.t. lemma}}\label{appendix proof of nlog^2n lemma}
\begin{lemma} 
The above implementation implies an $O(n \log ^2 n)$ weighted feasibility test.
\end{lemma}
...
\section{Proof of Theorem~\ref{nlogn weighted f.t. theorem}}\label{appendix proof of nlogn theorem}
\begin{theorem}
The above implementation implies an $O(n \log n)$ weighted feasibility test.
\end{theorem}
