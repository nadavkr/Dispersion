...
In this section we present an $O(n\log n)$ time algorithm for the weighted decision problem (a simple matching lower bound is shown in Appendix \ref{appendix weighted f.t. lower bound}).
