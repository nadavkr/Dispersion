...
and recall that its goal is to choose as many nodes as possible, and in case of a tie to maximize the distance of the
...
for any $j=1,2,\ldots,i'$. Therefore, to continue the simulation we have to run the procedure on $u_{1},u_{2},u_{i'}$.
